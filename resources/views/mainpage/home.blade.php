...
<Section class="banner-area">
    <div class="container px-5">
        <div class="row">
            <div class="contain-head col-lg-6" data-aos="fade-right">
            ...
            <div class="contain-img col-lg-6 " data-aos="fade-left">
...
<section class="calculator-area py-5" id='getQuote'>
    <div class="container-md">
        <div class="container-form p-2 rounded shadow-lg bg-white" style="max-width: 1200px; margin: auto; ">
            ...
            <form class="d-flex w-100 justify-content-between mt-4" id="calc-form" action="{{ route('retrieveShipments') }}" method="get">
                @csrf
                {{-- <div class="row d-flex "> --}}
                    ...
                    <div class="col-md-2 mt-3">
                        ...
                        <div class=" d-flex justify-content-center align-items-center mt-3">
                            <button type="submit" class="btn btn-primary px-4 fw-bold btn-lg" style="padding: 10px 0; font-size: 1.2rem;">Get Quote</button>
